      ...
      <table class="table table-hover">
        ...
        <div class="detailTransaksiCustomer">
          <tbody>
            ...
            $ttl    = 0;
            $no_transaksi = 0;
            $sql1 = "SELECT a.tgl_transaksi, b.qty, b.harga, b.id_detail, b.no_transaksi, c.nama_menu FROM tbl_transaksi a INNER JOIN tbl_transaksi_detail b ON a.no_transaksi = b.no_transaksi INNER JOIN tbl_menu c ON b.id_menu = c.id_menu WHERE a.kode_member = '$kode_member' AND a.total_bayar = 0 ORDER BY a.no_transaksi";
            ...
            while ($data1   = mysqli_fetch_array($query1)) {
              ...
              <tr>
                ...
                <form action="transaksi-member-ubah.php" method="POST">
                  <td >
                  ...
                  <td align="center" class="aksiCustomer">
                    <a href="transaksi-member-delete.php?id_detail=<?= $data1['id_detail']; ?>" class="badge badge-danger p-2 delete-data" title="Delete"><i class="fas fa-trash"></i></a> | 
                    <button type="submit" class="btn btn-primary p-1" id="ubah-data" title="Ubah"><i class="fas fa-edit"></i></button> 
                  </td>
                </form>
              </tr>
              <?php
   ...
   // Bayar
    $(document).on('click', '#customerBayar', function() {
      ...
      $.ajax({
        ...
        url: 'transaksi-member-bayar-ajax.php',
        cache: false,
        success: function() {
